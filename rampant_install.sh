...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='Rampant.conf'
CONFIGFOLDER='/root/.Rampant'
COIN_DAEMON='Rampantd'
COIN_CLI='Rampantd'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/rampantco/Rampton-Coin/files/1867833/Rampantd_.Linux_Daemon_Ubuntu_16.04.tar.gz'
